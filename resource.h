...
/* Update the operand latency of a resource */
void res_update_oplat(struct res_desc *pool, int ndesc, int class, int oplat);

/* Update the issue latency of a resource */
void res_update_issuelat(struct res_desc *pool, int ndesc, int class, int issuelat);
